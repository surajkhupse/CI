...
class projects extends CI_Controller {
  ...
  if(!$this->session->userdata('logged_in')){
	...
	$this->session->set_flashdata('no_access', 'Sorry You Are  Npt Allowed Or Not Logged In');
   redirect('home/index');	
  }
}
           ...
           $data= array(
			 ...
			 'project_body' => $this->input->post('project_body')       
			  ...
			  if($this->project_model->create_project($data)) {
					 $this->session->set_flashdata('project_created','Your project created');
        ...
        $data['project_data'] = $this->project_model->get_project_info($project_id);
		  ...
		  $this->load->view('layouts/main',$data);
             ...
             $data= array(
				...
				$this->session->set_flashdata('project_update','Your project updated');
